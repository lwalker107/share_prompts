// Whenever you are using hooks from react like useEffect/useState you must add a directive known as "use client"
'use client'
    ...
    <nav className="flex-between w-full mb-16 pt-3">
      ...
      <div className="sm:flex hidden">
        {session?.user ? (
          ...
          // allows us to map through all the buttons and shows us the provider buttons
          <>
            {providers && 
